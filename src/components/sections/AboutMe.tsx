...
const RecentTechSelection = styled.svg`
  position: absolute;
  top: 0;
  left: -20px;
  width: 100%;
        ...
        <Summary>
          <ContentPart>
            ...
            <Description>
              ...
              my knowledge of web technologies. Among plenty of small projects,
              I managed to acomplish several larger, which are listed in the
              section below. Besides programming, my interests also include
              mathematics and electronic music.
            </Description>
          </ContentPart>
